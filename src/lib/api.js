...
export async function fetchWallpaper() {
    try {
        ...
        console.error('fetchWallpaper 网络请求失败:', error);
        return { success: false, message: `网络请求失败: ${error.message}` };
    }
}

export async function saveWallpaper(wallpaperData) {
    try {
        const response = await fetch('/api/wallpaper', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
        ...
        console.error('saveWallpaper 网络请求失败:', error);
        return { success: false, message: `网络请求失败: ${error.message}` };
    }
}
...
export async function deleteWallpaper() {
    try {
        ...
        console.error('deleteWallpaper 网络请求失败:', error);
        return { success: false, message: `网络请求失败: ${error.message}` };
    }
}