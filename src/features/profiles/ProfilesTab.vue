...
// Export Modal
const SubscriptionExportModal = defineAsyncComponent(() => import('./components/SubscriptionExportModal.vue'));
          ...
          <div class="relative" ref="profilesMoreMenuRef">
            ...
            <Transition name="slide-fade-sm">
              <div v-if="showProfilesMoreMenu"
                class="absolute right-0 mt-2 w-36 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl z-50 ring-2 ring-gray-200 dark:ring-gray-700 border border-gray-300 dark:border-gray-700">
