      ...
      <div class="flex-grow flex flex-col justify-start space-y-3">
        <div class="relative">
          ...
          <input 
            ...
            :value="node.url"
            readonly 
            class="w-full px-3 py-2 text-sm text-gray-500 dark:text-gray-400 font-mono bg-gray-50/60 dark:bg-gray-900/75 border border-gray-200 dark:border-gray-700 rounded-xl transition-all duration-300 focus-enhanced truncate"
          />
        </div>
      </div>
    </div>
