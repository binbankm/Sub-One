              ...
              <div class="flex items-center gap-3 flex-shrink-0">
                ...
                <div class="relative" ref="subsMoreMenuRef">
                  ...
                  <Transition name="slide-fade-sm">
                    <div v-if="showSubsMoreMenu" class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-2xl shadow-xl z-10 ring-1 ring-black ring-opacity-5 opacity-100">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-6">
          <div class="flex items-center gap-4">
            ...
            <div class="relative" ref="profilesMoreMenuRef">
              ...
              <Transition name="slide-fade-sm">
                <div v-if="showProfilesMoreMenu" class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-2xl shadow-xl z-10 ring-1 ring-black ring-opacity-5 opacity-100">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8 gap-6">
          ...
          <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto justify-end sm:justify-start">
            ...
            <div class="relative" ref="nodesMoreMenuRef">
              ...
              <Transition name="slide-fade-sm">
                <div v-if="showNodesMoreMenu" class="absolute right-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-2xl shadow-xl z-10 ring-1 ring-black ring-opacity-5 opacity-100">
