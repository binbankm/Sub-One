  ...
  <div v-else class="w-full container-optimized">
    ...
    <div class="space-y-6 lg:space-y-8">
      ...
      <SubscriptionsTab 
        ...
        @toggle-sorting="() => { 
          if (isSortingSubs && hasUnsavedSortChanges && !confirm('有未保存的排序更改，确定要退出吗？')) return;
      ...
      <ProfilesTab 
        ...
        @change-profile="handleProfileToggle"
      ...
      <NodesTab 
        ...
        @save-sort="handleSaveSortChanges"
        @toggle-sorting="() => {
          if (isSortingNodes && hasUnsavedSortChanges && !confirm('有未保存的排序更改，确定要退出吗？')) return;
