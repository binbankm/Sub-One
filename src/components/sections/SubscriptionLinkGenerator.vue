      ...
      <div class="relative z-10">
        ...
        <div class="mb-6">
          ...
          <select v-model="selectedId"
            class="w-full px-4 py-3 text-sm bg-white/60 dark:bg-gray-800/75 border border-gray-300/50 dark:border-gray-700/50 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200">
        ...
        <!-- 提示信息 -->
        <div v-if="config?.mytoken === 'auto'"
          class="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border-2 border-yellow-200 dark:border-yellow-800 animate-pulse-breathing">
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-yellow-600 dark:text-yellow-400">当前为自动Token，链接可能会变化。为确保链接稳定，推荐在"设置"中配置一个固定Token。
              </p>
            </div>
          </div>
        </div>
