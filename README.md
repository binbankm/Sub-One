...
│       ├── ProfileModal.vue             # 订阅组弹窗
│       ├── ProfileNodeDetailsModal.vue  # 订阅组节点详情弹窗
│       ├── SettingsModal.vue            # 设置弹窗
│       ├── SubscriptionImportModal.vue  # 订阅导入弹窗
│       └── SubscriptionTestModal.vue    # 订阅测试弹窗
├── composables/         # 组合式函数
│   ├── useSubscriptions.js  # 订阅管理
│   └── useManualNodes.js    # 手动节点管理
├── stores/             # Pinia状态管理
│   ├── session.js      # 会话状态
│   ├── theme.js        # 主题状态
│   ├── toast.js        # 消息提示状态
...
- **Footer.vue**: 底部信息栏
- **Toast.vue**: 消息提示组件
- **ManualNodeList.vue**: 手动节点列表组件
- **DashboardSkeleton.vue**: 加载时的骨架屏组件

#### 卡片组件 (cards/)
- **Card.vue**: 订阅卡片组件
- **ProfileCard.vue**: 订阅组卡片组件
- **ManualNodeCard.vue**: 手动节点卡片组件
- **SkeletonCard.vue**: 骨架屏卡片组件
