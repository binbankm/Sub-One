...
describe('Manual Verification Output', () => {
    it('should generate converted configs', () => {
        ...
        output += JSON.stringify(sb.outbounds.filter((o: any) => o.type !== 'selector' && o.type !== 'urltest' && o.type !== 'direct' && o.type !== 'block' && o.type !== 'dns'), null, 2) + '\n';
        ...
        fs.writeFileSync('lib/shared/test/verify_output.txt', output);
